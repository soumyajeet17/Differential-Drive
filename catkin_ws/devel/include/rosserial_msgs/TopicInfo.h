...
struct TopicInfo_
{
  ...
  _message_type_type message_type;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _md5sum_type;
  _md5sum_type md5sum;
...
bool operator==(const ::rosserial_msgs::TopicInfo_<ContainerAllocator1> & lhs, const ::rosserial_msgs::TopicInfo_<ContainerAllocator2> & rhs)
{
...
struct Printer< ::rosserial_msgs::TopicInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rosserial_msgs::TopicInfo_<ContainerAllocator>& v)
  {
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "md5sum: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.md5sum);
    if (true || !indent.empty())
      s << std::endl;
